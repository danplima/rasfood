package br.om.rasmoo.restaurante.util;

import br.om.rasmoo.restaurante.dao.*;
import br.om.rasmoo.restaurante.entity.*;
...
public class CargaDeDadosUtil {
    ...
    public static void cadastrarProdutosCardapio(EntityManager entityManager) {
        ...
        Cardapio moqueca = new Cardapio("moqueca", "peixe liso", true, BigDecimal.valueOf(95.00), categorias.get(2));
    ...
    public static void cadastrarClientes(EntityManager entityManager) {
        ...
        Endereco rioVermelho = new Endereco("000000001","lapa","apto 1001","Salvador","SSA");
        ...
        Endereco heitorPenteado = new Endereco("000000000","lapa","apto 101","Sao Paulo","SP");
